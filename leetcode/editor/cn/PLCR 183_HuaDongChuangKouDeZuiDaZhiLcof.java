 ...
 * 望远镜中最高的海拔
 * @author DY
 * @date 2026-08-22 17:11:21
 */
public class PLCR 183_HuaDongChuangKouDeZuiDaZhiLcof {
    public static void main(String[] args) {
        Solution solution = new PLCR 183_HuaDongChuangKouDeZuiDaZhiLcof().new Solution();
        // 在此处编写本地测试逻辑
    }
