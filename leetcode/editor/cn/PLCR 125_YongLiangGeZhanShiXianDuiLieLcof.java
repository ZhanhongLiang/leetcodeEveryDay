 ...
 * 图书整理 II
 * @author DY
 * @date 2026-08-22 14:29:40
 */
public class PLCR 125_YongLiangGeZhanShiXianDuiLieLcof {
    public static void main(String[] args) {
        Solution solution = new PLCR 125_YongLiangGeZhanShiXianDuiLieLcof().new Solution();
        // 在此处编写本地测试逻辑
    }
